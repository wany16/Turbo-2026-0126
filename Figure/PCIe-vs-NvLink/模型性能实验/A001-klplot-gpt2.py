...
# '''
tokens = ['512', '768', '1024']
tokens = ['256','384','512','640','768','896','1024']
# turbo_data = [0.000132, 0.000087, 0.000067]
# int8_data = [0.000232, 0.000159, 0.000122]
turbo_data = [0.000082,0.000155,0.000132,0.000105,0.000087,0.000075,0.000067]
int8_data = [0.000082,0.000265,0.000232,0.000192,0.000159,0.000138,0.000122]
# '''
#qwen的数据
'''
tokens = ['512', '768', '1024', '1280', '1536', '1792', '2048']
...
plt.yscale('symlog', base=10, linthresh=0.0004)
plt.yticks([0.0001, 0.001, 0.01, 0.05],[r'$10^{-4}$', r'$10^{-3}$', r'$10^{-2}$', '0.05'],fontsize=font_size_yticks)
...
plt.tight_layout()
dst_path = r'E:/Turbo-SIGCOMM-2026-Github/Turbo-2026-0126/Figure/PCIe-vs-NvLink/Figures/kl-gpt-001.pdf'
